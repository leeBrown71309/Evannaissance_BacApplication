...
class FormModify extends StatefulWidget {
  var idpro;
  FormModify(this.idpro);

  @override
  _FormModifyState createState() => _FormModifyState();
}

class _FormModifyState extends State<FormModify> {
...
// les controller qui permettent de controller les information entrer
  ...
  Future<void> ModifyProjet()async {
    var url = Uri.parse("http://192.168.1.16/workstation/flutter%20app%20auth/modifyprojets.php");
