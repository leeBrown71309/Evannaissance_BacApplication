...
import 'package:ergo/MainPages/Admin/ListEmployes.dart';
...
//methode permettant de recuperer les valeurs des champs a l'aide des controller
  ...
  Future<void> register(var titre)async {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: TextFormField(
                ...
                validator: (value) =>value!.isEmpty ?
                'Enter votre votre matricule' : null,
